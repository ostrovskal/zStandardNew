...
static int crypthead(const char* passwd, unsigned char* buf, int bufSize, unsigned long* pkeys, const unsigned long* pcrc_32_tab, unsigned long crcForCrypting) {
	...
	init_keys(passwd, pkeys, pcrc_32_tab);
	for(n = 0; n < RAND_HEAD_LEN - 2; n++) buf[n] = (unsigned char)zencode(pkeys, pcrc_32_tab, header[n], t);
	buf[n++] = (u8)zencode(pkeys, pcrc_32_tab, (int)(crcForCrypting >> 16) & 0xff, t);
	buf[n++] = (u8)zencode(pkeys, pcrc_32_tab, (int)(crcForCrypting >> 24) & 0xff, t);
	return n;
}
